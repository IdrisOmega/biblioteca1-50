...
public class Main {
    public static void main(String[] args) {
        ...
        Libros libro3 = new Libros("IT", "Stephen King", "SDKF54654KLJ", false);
        ...
        while (submenu) {
            ...
            switch (opcionesmenu) {
                case 1:
                    ...
                    System.out.println("2.escribe tu apellido");
                    String apellidousuario=scaner.nextLine();
                    System.out.println("3.escribe tu telefono");
                    int telefonousuario=scaner.nextInt();
                    scaner.nextLine();
                    System.out.println("4. escribe tu Gmail ");
                    String gmailusuario=scaner.nextLine();
                    System.out.println("su cuenta ha sido creada");
                    Usuarios registrado= new Usuarios(nombreusuario,apellidousuario,telefonousuario,gmailusuario);
                    biblioteca.agregarUsuario(registrado);

                    break;

                case 2:
                    System.out.println("por favor ingrese el nombre de su usuario de la biblioteca");
                    scanner.nextLine();
                    String nombreUsuario = scanner.nextLine();
                    Usuarios usuario = biblioteca.buscarUsuarioPorNombre(nombreUsuario);
                    if (usuario != null) {
                        System.out.println("bienvenido a la biblioteca");

                    } else {
                        System.out.println("su usuario no ha sido encontrado, porfavor escriba bien su nombre o registrese primero");
                    }
                    break;
                ...
                switch (opcionMenu) {
                    ...
                    case 3:
                        ...
                        if (usuarioPedido != null) {
                            ...
                            if(libroPedido.librodisponible==false){
                                biblioteca.agregarLibrosNoDisponibles(libroPedido);
                            }
                        } else {
                            System.out.println("Usuario no encontrado.");
                        }
